# Three Stage Course - Restaurant Reviews - stage 1
...
2. create file js\config.js

3. register @ https://www.mapbox.com/ and put you API token in config file. Code must me in format:

var config = {
  myMapboxToken : <YOUR_API_TOKEN>
}
